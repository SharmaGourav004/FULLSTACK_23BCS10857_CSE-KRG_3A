...
public class VetController {
    ...
    public List<VetBooking> myBookings(Authentication authentication) {
        ...
        List<VetBooking> bookings = vetBookingRepository.findByDoctor_IdOrderByStartAtDesc(doctor.getId());
        System.out.println("Doctor " + email + " (ID: " + doctor.getId() + ") has " + bookings.size() + " appointments");
        for (VetBooking b : bookings) {
            System.out.println("  - Booking ID: " + b.getId() + ", Patient: " + (b.getUser() != null ? b.getUser().getName() : "null") + 
                             ", Phone: " + b.getPhone() + ", Message: " + b.getMessage());
        }
        return bookings;
    }
